...
async function init() {
  ...
  try {
    ...
    if (img) {
      const base = (p == null ? void 0 : p.photoKey) ? mediaUrl(p.photoKey) : "/assets/avatar-fallback.svg";
      img.src = (p == null ? void 0 : p.photoKey) && needsBust(p.photoKey) ? `${base}?v=${Date.now()}` : base;
    }
