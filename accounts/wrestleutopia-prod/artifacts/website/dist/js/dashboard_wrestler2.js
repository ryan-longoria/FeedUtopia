...
async function loadRecommendedTryouts() {
  ...
  try {
    ...
    renderEmptyTryouts(target, corsy ? { title: "We can’t reach the API (CORS blocked)", desc: "If you’re the site owner, ensure the API returns the correct CORS headers and avoids 204 on GET." } : transient ? { title: "We’re having trouble loading events", desc: "This might be a temporary issue. Please refresh in a moment." } : void 0);
  }
}
