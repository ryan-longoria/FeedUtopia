...
resource "aws_lambda_function" "render_video" {
  ...
  package_type  = "Image"
  image_uri     = "481665084477.dkr.ecr.us-east-2.amazonaws.com/render_video_repository@sha256:19bc504e0ef34e5954f5343eb260c19304ed55cc587874ae4d380e7361a647c7"
  role          = aws_iam_role.lambda_role.arn
  timeout       = 300
  memory_size   = 3008
  environment {
