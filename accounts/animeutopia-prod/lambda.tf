...
resource "aws_lambda_function" "render_video" {
  ...
  package_type  = "Image"
  image_uri     = "481665084477.dkr.ecr.us-east-2.amazonaws.com/render_video_repository@sha256:cab443e5525ce323c85c8cd61a47f9c9c66f43b97965321200de9d21b9165676"
  role          = aws_iam_role.lambda_role.arn
  timeout       = 180
  environment {
    variables = {
